...
public:
	...
	TextureMap* getXposMap(){return tMap[0];}
	TextureMap* getYposMap(){return tMap[2];}
	TextureMap* getZposMap(){return tMap[4];}
	TextureMap* getXnegMap(){return tMap[1];}
	TextureMap* getYnegMap(){return tMap[3];}
	TextureMap* getZnegMap(){return tMap[5];}
